...
my %daemons = (
    "morph" => {
        "path" => __DIR__ . "/morph/analyser/morph_hin.exe",
        "args" => "--pdgmfilepath " . __DIR__ . "/morph/analyser/data/ " .
                  "--uwordpath " . __DIR__ . "/morph/analyser/data/dict_final " .
                  "--dictfilepath " . __DIR__ . "/morph/analyser/data/dict " .
                  "-ULDWH --tcpserver",
        "port" => "12003"
    }
);
